	...
	<view class="evaluateBox">
		<view class="evaluate-header">
			<view class="title">
				...
				<text v-if="isShowTotal" style="margin-left: 10upx;">门店评论 ({{ listData.length }})</text>
			</view>
			<view class="total">
				<!--<view class="stars">
				...
				<text style="font-size: 11px;">更多></text>
			</view>
		</view>
		...
		<view class="no-lists" v-else>
			<image class="no-lists-img" :src="tp01"></image>
			<view class="no-lists-btn">+添加评论</view>
		</view>
	</view>
</template>
...
export default {
	...
	data() {
		return {
            tp01: require('../../static/image/no-comment.jpg')
		}
	},
	methods: {
		previewImg(src,urls){
